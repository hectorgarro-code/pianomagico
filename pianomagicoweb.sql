...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2026 a las 22:03:14
...
--
-- Estructura de tabla para la tabla `user_performances`
--
...
INSERT INTO `user_profile` (`id`, `user_id`, `name`, `avatar_id`, `total_score`) VALUES
(1, 1, 'BASTIAN', 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_stickers`
--
...
--
-- Indices de la tabla `user_performances`
--
...
--
-- Indices de la tabla `user_stickers`
--
...
--
-- AUTO_INCREMENT de la tabla `user_medals`
--
ALTER TABLE `user_medals`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `user_performances`
--
ALTER TABLE `user_performances`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `user_stickers`
--
ALTER TABLE `user_stickers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `user_medals`
--
ALTER TABLE `user_medals`
  ADD CONSTRAINT `user_medals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `user_performances`
--
ALTER TABLE `user_performances`
  ADD CONSTRAINT `user_performances_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Filtros para la tabla `user_stickers`
--
ALTER TABLE `user_stickers`
  ADD CONSTRAINT `user_stickers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
